...
} from './components/variant-explorer/variant/subcomponents/variant-info/variant-info.component';
...
} from './components/variant-explorer/variant/subcomponents/variant-selection-button/variant-selection-button.component';
...
} from './components/variant-explorer/subvariant-explorer/subvariant-explorer.component';
...
} from './components/performance/node-selection-performance/node-selection-performance.component';
...
} from './components/performance/tree-performance-color-map/tree-performance-color-map.component';
...
} from './components/variant-explorer/conformance-info/variant-conformance-dialog/variant-conformance-dialog.component';
import {BpmnEditorComponent} from './components/bpmn-editor/bpmn-editor.component';
import {
  GoldenLayoutDummyComponent
} from './components/golden-layout-host/golden-layout-dummy/golden-layout-dummy.component';
import {
  SubVariantComponent
...
} from './components/variant-explorer/conformance-info/info-bar/conformance-info-bar.component';
...
} from './components/performance/performance-progress-bar/performance-progress-bar.component';
import {
  VariantQueryInfoComponent
} from './components/variant-explorer/variant-query/query-info/variant-query-info/variant-query-info.component';
import {
  VariantExplorerContextMenuComponent
} from './components/variant-explorer/variant-explorer-context-menu/variant-explorer-context-menu.component';
import {
  SyntaxHighlightedTextareaDirective
} from './directives/syntax-highlighted-textarea/syntax-highlighted-textarea.directive';
...
} from './components/variant-explorer/variant/subcomponents/tree-buttons/tree-performance-button/tree-performance-button.component';
import {
  InfixSelectionControllsComponent
} from './components/variant-explorer/variant/subcomponents/infix-selection-controlls/infix-selection-controlls.component';
import {ZoomFieldComponent} from './components/zoom-field/zoom-field.component';
import {
  VariantExplorerSidebarComponent
} from './components/variant-explorer/variant-explorer-sidebar/variant-explorer-sidebar.component';
...
} from './components/variant-explorer/variant/subcomponents/variant-info/conformance-status-icon/conformance-status-icon.component';
...
} from './components/variant-explorer/variant/subcomponents/tree-buttons/tree-conformance-button/tree-conformance-button.component';
import {DecimalPipe} from '@angular/common';
import {
  VariantMinerActivitiesFIlterComponent
} from './components/variant-miner/variant-miner-activities-filter/variant-miner-activities-filter.component';
...
} from './components/variant-explorer/clustering-settings-dialog/clustering-settings-dialog.component';
...
} from './components/process-tree-editor/process-tree-toolbox/process-tree-toolbox.component';
