...
export function generateVQLTheme(colorMap : Map<string, string>) : Monaco.editor.IStandaloneThemeData {

  const activityTokens = []
  colorMap.forEach((v, k) => activityTokens.push({token : 'activites.' + k, foreground : v}))
